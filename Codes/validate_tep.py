...
def plot_tep_analysis(evoked: mne.Evoked, 
    ...
    # Save figure
    fig.savefig(os.path.join(os.path.dirname(__file__), '..', 'Results', f'{session_name}_tep_analysis.png'),
...
def generate_validation_summary(components: Dict, 
    ...
    summary_path = os.path.join(os.path.dirname(__file__), '..', 'Results', f'{session_name}_validation_summary.txt')
